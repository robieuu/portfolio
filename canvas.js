window.addEventListener("load", () => {
  ...
  texts.push(new text("HTML and done many different types of projects ranging from simple games",0.008,30,{x:-2000,y:470},{x:-2000,y:470},{x:-2000,y:470}));
  texts.push(new text("to more complex algorithms like physics simulations, machine learnging and ray tracing",0.007,30,{x:-2000,y:520},{x:-2000,y:520},{x:-2000,y:520}));
